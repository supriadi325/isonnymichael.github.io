...
<head>
	...
	<script src="js/play.js?v=1.1"></script>  -->
...
<body>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav justify-content-end">
							...
							<!-- <li class="nav-item"><a class="nav-link" href="#games">Play Games</a></li> -->
				...
				<div class="row">
					<div class="col-lg-8">
						<div class="banner_content">
							...
							<h1 class="text-uppercase">I am Sonny Michael</h1>
							<h5 class="text-uppercase">Full Stack Developer</h5>
							<div class="d-flex align-items-center">
								<a class="primary_btn" href="#contact"><span>Get In Touch</span></a>
							</div>
						</div>
					</div>
					<div class="col-lg-4">
				...
				<div class="offset-lg-1 col-lg-5">
					<div class="main_title text-left">
						<h2>let’s <br>
							...
							myself</h2>
						<p>
							Love to learn something new and easy going. Experienced in three years being programmer I have working on variety project website, apps, and games. 
						</p>
						<a class="primary_btn" target="_blank" href="https://drive.google.com/file/d/0B82pgqn92ol3N3BHTXdCc3d3clE/view?usp=sharing"><span>Download CV</span></a>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="brand_area" id="skills">
		<div class="container">
			<div class="row justify-content-center">
				<div class="skills pb-5 mt-5" id="skills">
					<h1 class="text-center pb-3">Skills</h1>
					<div class="container">
					   <div class="row">
						  <div class="skill col-md-3 col-sm-6 col-12" style="background-color:#ff5d3a">
							 <svg class="skill-icon" viewBox="0 0 384 512" height="1em" width="1em" fill="currentColor" stroke="currentColor" stroke-width="0" xmlns="http://www.w3.org/2000/svg">
						  ...
						  <div class="skill col-md-3 col-sm-6 col-12" style="background-color:#006de8">
							 <svg class="skill-icon" viewBox="0 0 384 512" height="1em" width="1em" fill="currentColor" stroke="currentColor" stroke-width="0" xmlns="http://www.w3.org/2000/svg">
						  ...
						  <div class="skill col-md-3 col-sm-6 col-12" style="background-color:#f6d766">
							 <svg class="skill-icon" viewBox="0 0 448 512" height="1em" width="1em" fill="currentColor" stroke="currentColor" stroke-width="0" xmlns="http://www.w3.org/2000/svg">
						  ...
						  <div class="skill col-md-3 col-sm-6 col-12" style="background-color:#449c50">
							 <svg class="skill-icon" viewBox="0 0 448 512" height="1em" width="1em" fill="currentColor" stroke="currentColor" stroke-width="0" xmlns="http://www.w3.org/2000/svg">
							 ...
							 <h2 class="caption">NodeJS</h2>
						  </div>
						  <div class="skill col-md-3 col-sm-6 col-12" style="background-color:#00b786">
							 <svg class="skill-icon" viewBox="0 0 448 512" height="1em" width="1em" fill="currentColor" stroke="currentColor" stroke-width="0" xmlns="http://www.w3.org/2000/svg">
						  ...
						  <div class="skill col-md-3 col-sm-6 col-12" style="background-color:#737daf">
							 ...
							 <h2 class="caption">PHP</h2>
						  </div>
						  <div class="skill col-md-3 col-sm-6 col-12" style="background-color:#fe0030">
							 <svg class="skill-icon" viewBox="0 0 377.6 512" height="1em" width="1em" fill="currentColor" stroke="currentColor" stroke-width="0" xmlns="http://www.w3.org/2000/svg">
							 ...
							 <h2 class="caption">Java</h2>
						  </div>
						  <div class="skill col-md-3 col-sm-6 col-12" style="background-color:#ff474c">
							 <svg class="skill-icon" viewBox="0 0 640 512" height="1em" width="1em" fill="currentColor" stroke="currentColor" stroke-width="0" xmlns="http://www.w3.org/2000/svg">
						  ...
						  <div class="skill col-md-3 col-sm-6 col-12" style="background-color:#a4c639">
							 ...
							 <h2 class="caption">Android</h2>
						  </div>
						  <div class="skill col-md-3 col-sm-6 col-12" style="background-color:#f05033">
							 <svg class="skill-icon" viewBox="0 0 448 512" height="1em" width="1em" fill="currentColor" stroke="currentColor" stroke-width="0" xmlns="http://www.w3.org/2000/svg">
							 ...
							 <h2 class="caption">git</h2>
						  </div>
						  <div class="skill col-md-3 col-sm-6 col-12" style="background-color:#478aff">
							 <svg class="skill-icon" viewBox="0 0 512 512" height="1em" width="1em" fill="currentColor" stroke="currentColor" stroke-width="0" xmlns="http://www.w3.org/2000/svg">
								<path d="M256 161.2c-52.3 0-94.8 42.5-94.8 94.8s42.5 94.8 94.8 94.8 94.8-42.5 94.8-94.8-42.5-94.8-94.8-94.8z"></path>
								<circle cx="392.1" cy="126.4" r="43.2"></circle>
								<path d="M445.3 169.8l-1.8-4-2.9 3.3c-7.1 8-16.1 14.2-26.1 17.9l-2.8 1 1.1 2.7c8.6 20.7 13 42.7 13 65.2 0 93.7-76.2 169.9-169.9 169.9S86.1 349.7 86.1 256 162.3 86.1 256 86.1c25.4 0 49.9 5.5 72.8 16.4l2.7 1.3 1.2-2.7c4.2-9.8 10.8-18.5 19.2-25.2l3.4-2.7-3.9-2C321.6 55.8 289.5 48 256 48 141.3 48 48 141.3 48 256s93.3 208 208 208 208-93.3 208-208c0-30-6.3-59-18.7-86.2z"></path>
							 </svg>
							 <h2 class="caption">C#</h2>
						  </div>
						  <div class="skill col-md-3 col-sm-6 col-12" style="background-color:#fba919">
							 <svg class="skill-icon" viewBox="0 0 120 130" height="1em" width="1em" fill="currentColor" stroke="currentColor" stroke-width="0" xmlns="http://www.w3.org/2000/svg">
	...
	<!--================ Start Game Area =================-->
	<!-- <section class="games_area pb-5" id="games">
		<div class="container">
			<div class="row justify-content-center">
				<div class="">
					<h2>Play Game </h2>
					<p>
						Made by phaser javascript.
					</p>
				</div>
		...
		<div class="container">
			...
			<div class="row feature_inner">
				<div class="col-lg-3 col-md-6">
					<div class="feature_item h-100 shadow">
						<img src="img/services/s1.png" alt="">
						<h4>Programming Lessons/Training</h4>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="feature_item h-100 shadow">
		...
		<div class="container">
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-12">
					...
					<form id="gform" method="POST" action="https://script.google.com/macros/s/AKfycbxyvFqetMIZwdUTU2dw_vwYnVYcGrlTOEDIfBE5/exec">
						<div class="form-group">
							<label for="name">Your Email:</label>
							<input id="form-email" class="form-control col-6" type="email" name="email" required>
						</div>

						<div class="form-group">
							<label for="name">Name:</label>
							<input id="form-name" class="form-control col-6" type="text" name="name" required>
						</div>

						<div class="form-group">
							<label for="name">Message:</label>
							<textarea id="form-message" class="form-control col-8" type="text" rows="8" name="message" required></textarea>
						</div>
